...
var wordsList = ["discrete", "guru", "summit", "cumbersome", "relish", "frayed", "fleet", "reinforce", "eloquent", "respectively",
...
function startGame() {
  ...
  var tempWord = wordsList[Math.floor(Math.random() * wordsList.length)];
  chosenWord = new Word(tempWord);
